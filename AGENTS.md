...
## 0. Project Identity
* **Name:** BetCopilot AI Showcase
* **One-line value:** Cuts sports performance model validation from 12 hours to 10 minutes for modeling leads — generating statistics scorecards.
